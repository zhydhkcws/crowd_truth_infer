...
class CRH:
    def __init__(self,e2wl,w2el,label_set,datatype,distancetype,e2t):
        self.e2wl = e2wl
        self.w2el = w2el
        self.weight = dict()
        ...
        if self.datatype == 'continuous' and self.distype == 'normalized absolute loss':
            ...
            for example, worker_label_set in self.e2wl.items():
                ...
                if example in self.e2t:
                    self.truth[example] = e2t[example]
                    continue
...
if __name__ == "__main__":
    ...
    e2lpd, weight = CRH(e2wl,w2el,label_set,datatype,distancetype,e2t).Run(10)
